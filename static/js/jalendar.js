    ...
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            for (var j=0;j<60;j+=5 ){
                clockMin.push(div('div', 'option').text(j));
//				alert(clockCount);
            }
                ...
                div('div', 'jalendar-wood').append(
                    ...
                    div('div', 'jalendar-pages').append(
                        ...
                        div('div', 'header').css('background-color', settings.color).append(
							div('div','prv-left').append(div('a', 'prv-m')),
                           
                            div('h1'),
							div('div','nxt-right').append(div('a', 'nxt-m')),
            ...
            function calcMonth() {
                ...
                if ( month == d.getMonth() ) {
                    $this.find('.day.this-month').removeClass('today').eq(date-1).addClass('today').css('color', settings.colorDate);
                } else {
            ...
            calcMonth();
//            $('.prv-m').attr('href','https://ftp.bmp.ovh/imgs/2020/08/048134d5ab43a621.png'); 
//			 $('.nxt-m').attr('href','../images/left.png'); 
            var arrows = new Array ($this.find('.prv-left'), $this.find('.nxt-right'));
            ...
            function prevAddEvent() {
                ...
                $this.find('.today').css('color', settings.colorDate);
...
//                $(this).removeAttr('data-type').attr('data-type', 'disabled').children('.check').children().css('background-color', 'transparent');
				$(this).removeAttr('data-type').attr('data-type', 'disabled').children('.check').children().css('background','');
